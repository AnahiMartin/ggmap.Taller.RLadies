...
```{r bloque4.4}
NuevaYork <- geocode("Paris",source = "google")
...
map.Bernabeu <- get_map(location = Bernabeu,zoom = 20,maptype = "satellite")
ggmap(map.Bernabeu)
```
...
map.Bernabeu <- get_map(location = Bernabeu,zoom = 10,maptype = "satellite")
